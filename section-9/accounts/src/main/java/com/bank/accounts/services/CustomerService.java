...
public class CustomerService implements ICustomerService {
    ...
    @Override
    public CustomerFullDetailsDTO fetchCustomerDetails(String mobileNumber,String correlationId) {
        ...
        ResponseEntity<CardDTO> card=cardsFeignClient.fetchCardDetails(mobileNumber,correlationId);
        ResponseEntity<LoanDTO> loan=loansFeignClient.fetchLoanDetails(mobileNumber,correlationId);
